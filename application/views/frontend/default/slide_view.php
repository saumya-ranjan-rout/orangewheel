<nav class="st-menu st-effect-1" id="menu-1">
    ...
    <div class="doctor-details">
        <ul>
            ...
            <li class="clearfix">
                <strong class="float-left"><?php echo get_phrase('address');?> : </strong> <span class="float-left"><?php echo $doctor->current_address;?></span>
            </li>
            <li class="clearfix">
                <strong class="float-left"><?php echo get_phrase('degrees');?> : </strong> <span class="float-left">Audiologist</span>
            </li>
        </ul>
    ...
    <!-- <div class="appointment-btn doctor-book">
        <a href="#" class="btn btn-styled btn-base-1 btn-outline btn-icon-left">
