        ...
        <div class="row py-3">
            <div class="col-lg-12">
                <h1 class="heading text-uppercase c-white">
                    <?php echo (isset($department)) ? $department->name.' '. get_phrase('department') :
                        get_phrase('all_departments');?>
                </h1>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-9">
                        <div class="text-center text-lg-left">
                            ...
                            <?php echo get_phrase('get_in_touch_with_us');?>
                            </h1>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3">
                        <div class="py-4 text-center text-lg-right">
                            <a href="<?php echo site_url('home/contact_us');?>" class="btn btn-styled btn-base-1 btn-outline btn-icon-left">
                                <i class="fa fa-handshake-o"></i><?php echo get_phrase('contact_us');?>
                            </a>
                        </div>
                    </div>
                </div>
