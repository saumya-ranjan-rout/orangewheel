...
<nav class="navbar navbar-expand-lg  navbar-light bg-default navbar--link-arrow navbar--uppercase bayanno-nav">
    <div class="container navbar-container" style="margin-bottom: -30px;margin-top: -60px;">
        <!-- Brand/Logo -->
        <a class="navbar-brand" href="<?php echo site_url('home');?>">
            <img src="<?php echo base_url('uploads/logoo.png');?>" width="200"
                alt="">
        ...
        <div class="collapse navbar-collapse align-items-center justify-content-end" id="navbar_main">
            ...
            <ul class="navbar-nav" data-hover="dropdown">
                ...
                <?php echo $page_name == 'doctors' ? 'active' : ''; ?>">
                    ...
                    <?php echo get_phrase('audiologist');?>
                    </a>
                </li>
                <li class="nav-item
                <?php echo $page_name == 'about_us' ? 'active' : ''; ?>">
                    ...
                    <?php echo get_phrase('about');?>
                      ...
                      <li class="nav-item
                <?php echo $page_name == 'product' ? 'active' : ''; ?>">
                    <a class="nav-link" aria-haspopup="true" aria-expanded="false"
                        href="<?php echo site_url('home/product');?>">
                    <?php echo get_phrase('product');?>
                    </a>
                </li>
                <!-- <li class="nav-item
