        ...
        <?php foreach ($bed_allotment_info as $row) { ?>   
            <tr>
                ...
                <td>
                   ...
                   if( $row['discharge_timestamp']== ''){
                       echo '-';
                       
                   }else {
                    echo date("m/d/Y", $row['discharge_timestamp']); 
                    }?>
                  ...
                  <td>
                    ...
                    <a  onclick="showAjaxModal('<?php echo site_url('modal/popup/discharge_bed_allotment/'.$row['bed_allotment_id']);?>');" 
                        class="btn btn-warning btn-sm" style="color:black">
                            <i class="fa fa-check"></i> &nbsp;
                            <?php echo 'Discharge';?>
                    </a>
                    <a onclick="confirm_modal('<?php echo site_url('admin/bed_allotment/delete/'.$row['bed_allotment_id']); ?>')"
