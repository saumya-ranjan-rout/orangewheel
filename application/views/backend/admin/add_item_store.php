        ...
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-heading">
                <div class="panel-title">
                    <h3><?php echo get_phrase('add_item_store'); ?></h3>
                </div>
            </div>

            <div class="panel-body">

                <form role="form" enctype="multipart/form-data" class="form-horizontal form-groups" action="<?php echo site_url('admin/item_store/create'); ?>" method="post">

                    <div class="form-group">
                        <label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('item_store'); ?> <small style="color:red;">*</small></label>

                        <div class="col-sm-7">
                            <input type="text" name="item_store" class="form-control" id="field-1" required>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input type="text" name="store_code" class="form-control" id="field-2" required>
                        </div>
                    </div>
