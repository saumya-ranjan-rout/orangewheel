...
<table class="table table-bordered table-striped datatable" id="table-2">
    <thead>
        <tr>
            ...
            <th><?php echo get_phrase('challan_no'); ?></th>
    ...
    <tbody>
        ...
        foreach ($patient_issues as $row) { ?>
            <tr>
                ...
                <td>
                          <a href="<?php echo site_url('admin/main_edit_patient_item_issue/challan_edit/' . $row['id']); ?>" class="btn btn-primary">
  <i class="fa fa-pencil"></i> </a>
                    <a onclick="showAjaxModal('<?php echo site_url('modal/popup/patient_item_issue_challan/' . $row['id']); ?>');" class="btn btn-info btn-sm">
                      ...
                      <a href="<?php echo site_url('admin/delete_patient_item_issue/challan/' . $row['id']); ?>" class="btn btn-danger">
