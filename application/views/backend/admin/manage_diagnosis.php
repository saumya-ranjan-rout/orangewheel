<button onclick="showAjaxModal('<?php echo site_url('modal/popup/add_diagnosis'); ?>');" class="btn btn-primary pull-right">
    <i class="fa fa-plus"></i>&nbsp;<?php echo get_phrase('add_diagnosis'); ?>
</button>
...
<table class="table table-bordered table-striped datatable" id="table-2">
    ...
    <tbody>
        <?php foreach ($diagnosis_info as $row) { ?>
            <tr>
                ...
                <td>
                    <a onclick="showAjaxModal('<?php echo site_url('modal/popup/edit_diagnosis/' . $row['id']); ?>');" class="btn btn-info btn-sm">
                        <i class="fa fa-pencil"></i>&nbsp;
                        <?php echo get_phrase('edit'); ?>
                    </a>
                    <a onclick="confirm_modal('<?php echo site_url('admin/diagnosis/delete/' . $row['id']); ?>')" class="btn btn-danger btn-sm">
