...
<table class="table table-bordered table-striped datatable" id="table-2">
    <thead>
        <tr>
            ...
            <th><?php echo get_phrase('money_receipt_no'); ?></th>
    ...
    <tbody>
        ...
        foreach ($patient_issues as $row) { ?>
            <tr>
                ...
                <td>
                <a href="<?php echo site_url('admin/main_edit_patient_item_issue/money_receipt_edit/' . $row['id']); ?>" class="btn btn-primary">
  <i class="fa fa-pencil"></i> </a>
                <a href="<?php echo site_url('admin/generatePdf/' . $row['id']); ?>" class="btn btn-default" target="_blank">
  <i class="fa fa-eye"></i> &nbsp;<?php echo get_phrase('view_money_receipt'); ?>
</a>
                    <a href="<?php echo site_url('admin/generate_moneyreceipt_invoice/'. $row['id']);?>" class="btn btn-success btn-sm">
                        <i class="fa fa-plus"></i> &nbsp;
                        <?php echo get_phrase('generate_invoice'); ?>
                    </a>
                     <a href="<?php echo site_url('admin/delete_patient_item_issue/moneyreceipt/' . $row['id']); ?>" class="btn btn-danger">
