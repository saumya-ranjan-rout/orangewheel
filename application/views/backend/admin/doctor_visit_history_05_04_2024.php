...
<div class="row">
    ...
    <table class="table table-bordered" id="myTable">
      <input type="text" name="doctor_name" value="<?php echo $referred_by; ?>">

    
    <thead>
        <tr>
            <th style="background-color: #AAA8A8; color:white;"><input type="checkbox" id="checkAll"></th>
    ...
    <tbody>
        ...
        ?>   
        <tr>
            <td><input type="checkbox" class="rowCheckbox" name="checkbox_name_<?php echo $cc; ?>"></td>
            <td><?php echo $row['name']."[". $row['code']."]"?>
             <input type="text" name="patient_id[]"value="<?php echo $row['patient_id'];?>">
...
$cons_info = $this->db->where('patient_id', $row['patient_id'])
 ...
 <input type="text" name="pat_diag_id[]"value="<?php echo $row1['id'];?>">
...
$patient_issues = $this->db->where('patient_id', $row['patient_id'])
                      ...
                      ->result_array();
                            ...
                            foreach ($patient_issues as $row3) { ?>    
                             ...
                             <input type="text" name="pat_item_issue_id[]"value="<?php echo $row3['id'];?>">
     ...
     <tfoot>
        <tr>
            <td style="text-align:right;font-weight:bold;color:#000" colspan="4">Diagnosis Grand Total :
              <input type="text" class="" name="diag_grand_total" ></td>
            ...
            <td style="text-align:right;font-weight:bold;color:#000">Item Grand Total :
             <input type="text" class="" name="item_grand_total" ></td>
        ...
        <tr>
            <td colspan="7" align="center"><button type="submit">Submit</button></td>
        </tr>
    </tfoot>   
</table>
               </form>
