...
?>
<div class="row">
    <form action="<?php echo site_url('admin/demoitem'); ?>" method="post" enctype="multipart/form-data">
...
<br><button onclick="showAjaxModal('<?php echo site_url('modal/popup/add_demoitem'); ?>');" class="btn btn-primary pull-right">
        ...
        ?>
            <tr>
                ...
                <td>
                    ...
                    $item_prices = $this->db->get_where('demoitem_price_details', array('item_id' => $row['id']))->result_array();
                ...
                <td>
                    <a href="<?php echo site_url('admin/change_demoprice/' . $row['id']); ?>" class="btn btn-success btn-sm">
                        &#8377;&nbsp;
                        <?php echo 'Change Price'; ?>
                    </a>
                    <a onclick="showAjaxModal('<?php echo site_url('modal/popup/edit_demoitem/' . $row['id']); ?>');" class="btn btn-info btn-sm">
                        <i class="fa fa-pencil"></i>&nbsp;
                        <?php echo get_phrase('edit'); ?>
                    </a>
                    <a onclick="confirm_modal('<?php echo site_url('admin/demoitem/delete/' . $row['id']); ?>')" class="btn btn-danger btn-sm">
