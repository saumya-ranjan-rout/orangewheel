...
-->
            ...
            <span id="models">
                <div class="row" style="margin-top: 10px;">
                    ...
                    <div class="col-sm-1">
                        ...
                        <input type="text" class="form-control" id="diagnosis_price_1" name="diagnosis_price[]" value=""  onkeyup="calculate_total_price(1)"/>
                    </div>
                    ...
                    <div class="col-sm-2">
                        ...
                        <input type="number" class="form-control" id="discount_price_1" name="discount_price[]" value="" onkeyup="calculate_total_price(1)" />
                    </div>
                     <div class="col-sm-2">
                        <label><?php echo get_phrase('total_price'); ?></label>
                        <input type="text" class="form-control total_price" id="total_price_1" name="total_price[]" value="" readonly />
                    </div>
            ...
            <span id="model_input">
                <div class="row" style="margin-top: 10px;">
                    ...
                    <div class="col-sm-1">
                        <input type="text" class="form-control" id="diagnosis_price" name="diagnosis_price[]" value="" onkeyup="calculate_total_price()" />
                    </div>
                    <div class="col-sm-1">
                    ...
                    <div class="col-sm-2">
                        <input type="number" class="form-control" id="discount_price" name="discount_price[]" value=""  onkeyup="calculate_total_price()"/>
                    </div>
                      <div class="col-sm-2">
                        <input type="text" class="form-control total_price" id="total_price" name="total_price[]" value="" readonly />
                    </div>
                    <div class="col-sm-1">
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if(data.discount_type ==''){
                        $('#discount_type_' + append_id).attr('value', 'Null');
                    }else{
   ...
   // $("#models").append(newModel);
      ...
      $('#diagnosis_price').attr('id', 'diagnosis_price_' + model_count);
        $('#discount_type').attr('id', 'discount_type_' + model_count);
         $('#diagnosis_price_' + model_count).attr('onkeyup', 'calculate_total_price(' + model_count + ')');
  
       
        $('#discount_price').attr('id', 'discount_price_' + model_count);
        $('#discount_price_' + model_count).attr('onkeyup', 'calculate_total_price(' + model_count + ')');
