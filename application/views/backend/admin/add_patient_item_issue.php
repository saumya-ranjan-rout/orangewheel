...
<div class="panel panel-primary" data-collapsed="0">
  ...
  width: 70%;" readonly>
            ...
            <div class="row" align="right" style="margin-top: 10px;">
                <label for="field-ta" class="col-sm-10 control-label"><?php echo 'Advance Amount'; ?></label>

                <div class="col-sm-2">
                     <input type="text" name="received_amount" class="form-control" id="received_amount" onkeyup="validateAndCalculate()" min="1" max="" />
                </div>
            </div>
  ...
  //    $('#model_price_' + append_id).attr('value', "");
    ...
    function add_model() {
      ...
      //  alert(model_count);
       ...
       get_invoice_number(issue_type,model_count)
    }
    ...
    function calculate_grand_total_amount() {
        ...
        $('#received_amount').attr('max',grand_total.toFixed(2));
        calculate_due_amount();
    }
...
var due_amount = finalTotal - received_amount;
    ...
    function get_invoice_number(type,new_model_count) {
    if (type == 'challan') {
        ...
        $('#model_id_'+new_model_count).html(options);
    ...
    if (type == 'challan') {
        ...
        $('.sk').each(function(index) {
                                 ...
                                 $('#model_id_' + currentIndex).val('');
        $('#model_id_' + currentIndex).trigger('change.select2');
