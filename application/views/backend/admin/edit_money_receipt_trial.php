...
<ol class="breadcrumb bc-3" style="margin-bottom: 0px;">
    ...
    <li>
        <a href="<?php echo site_url('admin/patient_item_issue_trial'); ?>">
            <?php echo get_phrase('patient_item_issue') ?>
        </a>
    </li>
    <li><?php echo get_phrase('money_receipt_edit') ?></li>
</ol>
<br>
...
<div class="panel panel-primary" data-collapsed="0">
    ...
    <div class="panel-heading">
        <div class="panel-title">
            <h3><?php echo get_phrase('money_receipt_edit'); ?></h3>
        </div>
    </div>

    <div class="panel-body">

        <form role="form" class="form-horizontal form-groups" action="<?php echo site_url('admin/patient_item_issue_trial/mainupdate'); ?>" method="post" enctype="multipart/form-data">
            <div class="row">
                <div class="col-sm-3">
                ...
                <div class="col-sm-3">
                    <label><span id="date_span"><?php echo get_phrase('money_receipt_date'); ?></span> <small style="color:red;">*</small></label>
                    <input type="text" name="money_receipt_date" class="form-control datepicker" value="<?php echo date('m/d/Y', strtotime($patient_item_issue_info["money_receipt_date"])); ?>" id="money_receipt_date" required>
                </div>
                <div class="col-sm-3">
...
foreach($models as $model) { ?>
                ...
                <div class="row" style="margin-top: 10px;">
                    <div class="col-sm-2">
                        ...
                        <select name="model_id[]" class="form-control select2" onchange="get_demo_model_available_quantity(this.value, 1)" required >
                    ...
                    <div class="col-sm-2">
                        ...
                        <input type="number" class="form-control" name="model_quantity[]" id="model_quantity_1" min="1" max="999" value="<?php echo $result['quantity']; ?>" readonly required />
                    </div>

                    <div class="col-sm-2">
                        <label><?php echo get_phrase('price'); ?></label>
                        <input type="text" class="form-control" id="model_price_1" name="model_price[]" value="<?php echo $result['unit_price']; ?>" readonly />
                    </div>
                    ...
                    <div class="col-sm-2">
                        ...
                        <input type="text" class="form-control" id="discount_percentage_1" name="discount_percentage[]" onkeyup="calculate_total_price_by_discount(1)" value="<?php echo $model['discount_percentage']; ?>"  />
                    </div>
                    <div class="col-sm-2">
         ...
         <span id="after_discount_1"> <?php $after_amount =$result['unit_price']-$model['discount']; echo "<b>(".$result['unit_price'] . "-" . $model['discount'] . "=" .$after_amount.")</b>"; ?></span>
                    ...
                    <div class="col-sm-2">
                        ...
                        <input type="text" class="form-control" id="tax_percentage_1" name="tax_percentage[]" value="<?php echo $model['tax_percentage']; ?>" readonly />
                    </div>
                    
                    <div class="col-sm-2">
                        <label><?php echo get_phrase('tax')." ".get_phrase('amount'); ?></label>
                        <input type="text" class="form-control" id="tax_1" name="tax[]" value="<?php echo $model['tax']; ?>" readonly />
                    </div>
                    <div class="col-sm-2">
                        <label><?php echo get_phrase('total_price'); ?></label>
                        <input type="text" class="form-control" id="total_price_1" name="total_price[]" value="<?php echo $model['total_price']; ?>" readonly />
                    </div>
                    <!-- <div class="col-sm-1">
...
<?php  }  ?>
            ...
            <span id="model_input">
                ...
                <div class="row" style="margin-top: 10px;">
                    <div class="col-sm-2">
                         <label><?php echo get_phrase('models'); ?> <small style="color:red;">*</small></label>
                        <select name="model_id[]" class="form-control" onchange="get_demo_model_available_quantity(this.value)" id="model_id">
                            <option value=""><?php echo get_phrase('select_a_model'); ?></option>
                            <?php
                            foreach ($item_info as $row) {
                                $available_quantity = $row['quantity'] - $row['sold_quantity'];
            ...
            <div class="row" align="right" style="margin-top: 10px;">
                ...
                <div class="col-sm-2">
                    <input type="number" name="received_amount" class="form-control" value="<?php echo $patient_item_issue_info['received_amount']; ?>" id="received_amount" onkeyup="calculate_due_amount()" />
                </div>
            </div>
...
<script type="text/javascript">
    ...
    function get_demo_model_available_quantity(model_id, append_id) {
        if (model_id != '') {
            $.ajax({
                url: '<?php echo site_url('admin/get_demo_model_available_quantity/'); ?>' + model_id,
    ...
    function add_model() {
        ...
        $('#model_id_' + model_count).attr('onchange', 'get_demo_model_available_quantity(this.value, ' + model_count + ')');
