<!-- <a href="<?php echo site_url('admin/create_patient_item_issue_trial'); ?>" class="btn btn-primary pull-right">
...
<table class="table table-bordered table-striped datatable" id="table-2">
    <thead>
        <tr>
            ...
            <th><?php echo get_phrase('advance_received_amount'); ?></th>
            <th><?php echo get_phrase('final_amount_payable'); ?></th>
    ...
    <tbody>
        ...
        $patient_issues = $this->db->where(array('issue_type'=> $list, 'demo' => 0))->get('patient_item_issue')->result_array();
        foreach ($patient_issues as $row) { ?>
            <tr>
                    ...
                    <div>
                        <table style="width: 100%;">
                            <tr>
                                ...
                                <td style="text-align: center;"><?php echo get_phrase('old_price'); ?></td>
                            ...
                            foreach ($models as $row2) { ?>
                                <tr>
                                    ...
                                    <td style="text-align: center;"><?php echo $row2->quantity; ?></td>
                                            <td style="text-align: center;"><?php echo $row2->old_price; ?></td>
                ...
                <td><?php echo $row['grand_total']; ?></td>
                   <td><?php echo "Coupon:".$row['coupon']; ?><br><?php echo "Coupon Perc:".$row['coupon_perc']; ?><br><?php echo "Coupon Value:".$row['coupon_value']; ?></td>
                ...
                <td>
                      <a href="<?php echo site_url('admin/main_edit_patient_item_issue/demo_edit/' . $row['id']); ?>" class="btn btn-primary">
  <i class="fa fa-pencil"></i> </a>
                    <a onclick="showAjaxModal('<?php echo site_url('modal/popup/patient_item_issue_invoice_trial/' . $row['id']); ?>');" class="btn btn-default btn-sm">
                        <i class="fa fa-eye"></i> &nbsp;
                        <?php echo get_phrase('view_invoice'); ?>
                    </a>
                     <a href="<?php echo site_url('admin/delete_patient_item_issue_trial/invoice/' . $row['id']); ?>" class="btn btn-danger">
  <i class="fa fa-trash-o"></i> </a>
  
  
    <?php if ($row['payment_status'] != 'paid') { ?>
  <a href="<?php echo site_url('admin/patient_item_issue_pay/icd/' . $row['id']); ?>" class="btn btn-success">
  <i class="fa fa-inr"></i> Pay </a>
  <?php } ?>
                </td>
            </tr>
        <?php } ?>
