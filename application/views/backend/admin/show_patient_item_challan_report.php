...
<div class="row">
    <form action="<?php echo site_url('admin/patient_item_challan_report'); ?>" method="post" enctype="multipart/form-data">
...
<table class="table table-bordered table-striped datatable" id="table-2">
    ...
    <tbody>
        <?php foreach ($patient_item_challan_info as $row) {
        ...
        ?>
                <tr>
                    ...
                    <td><?php echo date('d/m/Y', strtotime($row['challan_date'])); ?></td>
