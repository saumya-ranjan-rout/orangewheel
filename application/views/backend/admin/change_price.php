            ...
            <div class="panel panel-primary" data-collapsed="0">
                <div class="panel-heading">
                    <div class="panel-title">
                        <h3><?php echo 'Add Price'; ?></h3>
                    </div>
                </div>
                <div class="panel-body">
                    <form role="form" class="form-horizontal form-groups" action="<?php echo site_url('admin/change_item_price/create'); ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="panel-body">
                    <div class="tab-pane active" id="prescription" style="overflow-x:auto;">
                        ...
                        <table class="table table-bordered " id="myTable"><!--id="table-1"-->
                            ...
                            <tbody>
                                <?php
                                $report_info    = $this->db->get_where('item_price_details', array('item_id' => $item_id))->result_array();
                                $i = 1;
                                ...
                                foreach ($report_info as $row) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a onclick="showAjaxModal('<?php echo site_url('modal/popup/edit_item_price/' . $row['id']); ?>');" class="btn btn-info btn-sm" title="Edit Price Details">
                                                <i class="fa fa-pencil"></i>&nbsp;
                                            </a>
                                            <a onclick="confirm_modal('<?php echo site_url('admin/change_item_price/delete/' . $row['id']); ?>')" class="btn btn-danger btn-sm" title="Delete Diagnosis">
