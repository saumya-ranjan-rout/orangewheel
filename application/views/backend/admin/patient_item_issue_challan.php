...
?>
    ...
    <div id="invoice_print">
        ...
        <table width="100%" border="0">
            ...
            <tr>
                <td colspan="14"align="center"><h3 style="font-family:	Lucida Console;font-weight:bold;">Challan</h3></td>
        ...
        <table  class="table table-bordered" width="100%" border="1" style="border-collapse:collapse;">
            <tbody>
                <tr>
                    <td colspan="4"width='25%'>challan No.<br><b><?php echo $row['bill_no']; ?></b></td>
     ...
     if ($row2->tax_percentage > 0) {
        ...
        if (in_array($tax_percentage, $tax_row)) {
            ...
            $tax_row_value[] = $row2->tax; // Initialize the count to 1
               ...
               <tr>
                    ...
                    <td align="right" colspan="11" width="87%"><b>Coupon</b>(<?php echo $row["coupon_perc"]; ?>%)</td>
                    <td align="right" colspan="2" width="13%"><b>
                    
                    <?php echo number_format($row["coupon_value"],2, '.', ','); ?></b></td>
                </tr>
                <tr>
        ...
        <tr>
            ...
            <td align="right" colspan="11" width="87%"><b>Final Amount Payable</b></td>
        ...
        <table table class="table table-bordered" width="100%" border="1" style="border-collapse:collapse;">
            <tr>
                <td style="font-size: 14px;">Amount Chargeable (in words)<br><b><?php echo convertAmountToWords($totalamount); ?> Only</b></td>
            </tr>
        </table>
