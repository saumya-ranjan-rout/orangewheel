...
<?php echo $row4->price; ?>
    ...
    <input type="text" class="hiddenField" id="input_patient_item_price_<?php echo $item_count; ?>" value="<?php echo $row4->price; ?>" style="display: none; width: 50px;" onkeyup="updateItemPrice(<?php echo $item_count; ?>,<?php echo $count; ?>)">
                                    ...
                                    <td style="text-align: center;"><span id="patient_item_discountprice_<?php echo $item_count; ?>"  ondblclick="togglediscountEdititem(<?php echo $item_count; ?>)"> <?php if($row4->discount != ''){echo $row4->discount;} else {echo 0;}; ?></span>
                                
                                    <input type="text" class="hiddenField" id="input_patient_item_discountprice_<?php echo $item_count; ?>" value="<?php echo $row4->discount; ?>" style="display: none; width: 50px;" onkeyup="updateItemPrice(<?php echo $item_count; ?>,<?php echo $count; ?>)">
...
//alert(diagnosis_count);
    ...
    function togglediscountEdititem(diagnosis_count) {
//alert(diagnosis_count);

        var spanElement = document.getElementById('patient_item_discountprice_' + diagnosis_count);
        var inputElement = document.getElementById('input_patient_item_discountprice_' + diagnosis_count);
    ...
    function updateItemPrice(item_count, count) {
        ...
        var discountinputElement = document.getElementById('input_patient_item_discountprice_' + item_count);
        ...
        var discount = parseFloat(discountinputElement.value);
    ...
    function togglediscountEdit(diagnosis_count) {
//alert(diagnosis_count);

        var spanElement = document.getElementById('patient_diagnosis_discountprice_' + diagnosis_count);
        var inputElement = document.getElementById('input_patient_diagnosis_discountprice_' + diagnosis_count);
...
//alert(diagnosis_count);
    ...
    function updateDiagnosisPrice(diagnosis_count, count) {
        ...
        var discountinputElement = document.getElementById('input_patient_diagnosis_discountprice_' + diagnosis_count);
