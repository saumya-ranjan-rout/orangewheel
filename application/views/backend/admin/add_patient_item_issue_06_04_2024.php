            ...
            <span id="models">
                ...
                <div class="row" style="margin-top: 10px;">
                    <div class="col-sm-2">
                        ...
                        <select name="model_id[]" class="form-control select2 qua" onchange="get_model_available_quantity(this.value, 1)" required>
        ...
        $available_quantity = $row['quantity'];
            ...
            <span id="model_input">
                ...
                <div class="row" style="margin-top: 10px;">
                    <div class="col-sm-2">
                         <label><?php echo get_phrase('models'); ?> <small style="color:red;">*</small></label>
                        <select name="model_id[]" class="form-control qua" onchange="get_model_available_quantity(this.value)" id="model_id">
                            <option value=""><?php echo get_phrase('select_a_model'); ?></option>
                            <?php
                            foreach ($item_info as $row) {
                             //$available_quantity = $row['quantity'] - $row['sold_quantity'];
