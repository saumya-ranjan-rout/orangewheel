...
-->
        ...
        <li class="<?php if ($page_name == 'manage_item_category' || $page_name == 'manage_item_supplier' || $page_name == 'manage_item' || $page_name == 'manage_demoitem' || $page_name == 'manage_item_stock' || $page_name == 'manage_item_subcategory')
                        echo 'opened active'; ?> ">
            <a href="#">
            ...
            <ul>
                <li class="<?php if ($page_name == 'manage_item') echo 'active'; ?> ">
                    <a href="<?php echo site_url('admin/item'); ?>">
                        ...
                        <!-- <li class="<?php if ($page_name == 'manage_demoitem') echo 'active'; ?> ">
                    <a href="<?php echo site_url('admin/demoitem'); ?>">
                        <i class="entypo-dot"></i>
                        <span><?php echo "Demo ".get_phrase('item'); ?></span>
                    </a>
                </li> -->
        ...
        <li class="<?php if ($page_name == 'add_money_receipt' ||$page_name == 'manage_money_receipt' ||$page_name == 'manage_patient_item_issue_i' || $page_name == 'manage_patient_item_issue_c' || $page_name == 'add_patient_item_issue' || $page_name == 'add_patient_item_issue_trial' || $page_name == 'manage_patient_item_issue_trial_i' || $page_name == 'manage_sales_return' || $page_name == 'manage_patient_details' || $page_name == 'create_sales_return' || $page_name == 'manage_followup')
                        echo 'opened active'; ?> ">
            <a href="#">
            ...
            <li class="<?php if ($page_name == 'add_money_receipt') echo 'active'; ?> ">
                ...
                <li class="<?php if ($page_name == 'manage_patient_item_issue_c') echo 'active'; ?> ">
                    <a href="<?php echo site_url('admin/patient_item_issue/challan_list'); ?>">
                       ...
                       <!-- <li class="<?php if ($page_name == 'add_patient_item_issue_trial') echo 'active'; ?> ">
                    <a href="<?php echo site_url('admin/create_patient_item_issue_trial'); ?>">
                        <i class="entypo-dot"></i>
                        <span><?php echo 'Trial'; ?></span>
                    </a>
                </li> -->
                <li class="<?php if ($page_name == 'manage_patient_item_issue_trial_i') echo 'active'; ?> ">
                    <a href="<?php echo site_url('admin/patient_item_issue/trial_list'); ?>">
                        <i class="entypo-dot"></i>
                        <span><?php echo 'Trial Invoices'; ?></span>
                    </a>
                </li>
                
                  <li class="<?php if ($page_name == 'manage_sales_return') echo 'active'; ?> ">
                    <a href="<?php echo site_url('admin/sales_return_list/sales_return'); ?>">
                        <i class="entypo-dot"></i>
                        <span><?php echo get_phrase('sales_return'); ?></span>
                    </a>
                </li>
       ...
       <li class="<?php if ($page_name == 'show_operation_report' || $page_name == 'show_birth_report' || $page_name == 'show_death_report' || $page_name == 'show_item_report' || $page_name == 'show_item_stock_report' || $page_name == 'show_doctor_item_issue_report' || $page_name == 'show_patient_item_issue_report' || $page_name == 'show_patient_item_challan_report' || $page_name == 'manage_income_report'   || $page_name == 'manage_expense_report' || $page_name == 'manage_income_group_report' || $page_name == 'manage_expense_group_report'  || $page_name == 'doctor_commission_report')
            ...
            <ul>
                ...
                <li class="<?php if ($page_name == 'show_patient_item_challan_report') echo 'active'; ?> ">
                   ...
                   <li class="<?php if ($page_name == 'doctor_commission_report') echo 'active'; ?> ">
                    <a href="<?php echo site_url('admin/doctor_commission_report'); ?>">
                        <i class="entypo-dot"></i>
                        <span><?php echo get_phrase('doctor_commission_report'); ?></span>
                    </a>
                </li>
               <!-- Manoj End-->
