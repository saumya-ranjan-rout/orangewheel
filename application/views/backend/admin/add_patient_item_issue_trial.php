...
<li><?php echo get_phrase('add_patient_item_issue')." Trial" ?></li>
</ol>
<br>
...
<h3><?php echo get_phrase('add_patient_item_issue'). " Trial"; ?></h3>
</div>
</div>

<div class="panel-body">

<form role="form" class="form-horizontal form-groups" action="<?php echo site_url('admin/patient_item_issue_trial/create'); ?>" method="post" enctype="multipart/form-data">
<div class="row">
<div class="col-sm-3">
...
foreach ($patients as $row) { ?>
    ...
    foreach ($item_info as $row) {
        ...
        <input type="number" class="form-control sk" name="model_quantity[]" id="model_quantity_1" min="1" max="999" value="1" readonly required />
        </div>
