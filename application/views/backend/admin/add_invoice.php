    ...
    <div class="col-md-12">
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-body">
                ...
                <?php echo form_open(site_url('admin/invoice_add/create'), array('class' => 'form-horizontal form-groups invoice-add', 'enctype' => 'multipart/form-data')); ?>

                <div class="form-group">
                    <label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('invoice_title'); ?> <small style="color:red;">*</small></label>
                ...
                <div class="form-group">
                    <label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('patient'); ?> <small style="color:red;">*</small></label>
                        ...
                        <select name="patient_id" class="select2" id = "patient" required>
                            ...
                            foreach ($patients as $row2):
                                ...
                                <option value="<?php echo $row2['patient_id']; ?>">
                                    <?php echo $row2['name']; ?>(<?php echo $row2['phone']; ?>)
                                </option>
                            <?php endforeach; ?>
                        </select>
                    </div>
