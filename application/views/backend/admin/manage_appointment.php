        ...
        <?php foreach ($appointment_info as $row) { ?>   
            <tr>
                ...
                <td>
                    ...
                    <a onclick="confirm_modal('<?php echo site_url('admin/appointment/delete/'.$row['appointment_id']); ?>')"
    ...
    $(document).ready(function()
    {
        ...
        ({
            ...
            [
                 ...
                 foreach ($doctor as $roww):

               // $doctor_id      = $this->session->userdata('login_user_id');
               $doctor_id      =$roww['doctor_id'];
