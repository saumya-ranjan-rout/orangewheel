...
</style><?php $bloodgroup_info = $this->db->get('blood_bank')->result_array(); ?>
<div class="row">
    <div class="col-md-12">
        ...
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-body">
                ...
                <form role="form" enctype="multipart/form-data" class="form-horizontal form-groups"
                    action="<?php echo site_url('admin/receptionist/create'); ?>" method="post" onsubmit="disableButton()">
  ...
  <option value="other">Other</option>
                  ...
                  <!--  <div class="form-group">
                     ...
                     <div class="col-sm-7">
                          <a onclick="myFunction()" style="margin-left: 20px;"><img src="<?php echo base_url('uploads/camera.jpg');?>" alt="user-img" title="WEB CAM" class="rounded-circle img-fluid"     height="80" width="80" ></a>
