...
?>
        ...
        <table  class="table table-bordered" width="100%" border="1" style="border-collapse:collapse;">
            <tbody>
                <tr>
                    ...
                    <td colspan="5"width='25%'>Dispatched<br><b><?php echo $row['dispatched_through']; ?></b></td>
                </tr>
                <tr>
  ...
  //echo str_replace('.', '', number_format($row2->price, 2, ',', '.')); 
                    ...
                    ?>
                        ...
                        <tr >
                            ...
                            <td style="border-bottom: 0;border-top: 0;overflow: hidden; width:8%;font-size:13px;"><?php echo $model_info['hsn_code']; ?></td>
        ...
        if (in_array($tax_percentage, $tax_row)) {
            ...
            $tax_row_value[] = $row2->tax; // Initialize the count to 1
                ...
                <tr>
                    ...
                    <?php echo number_format($totalamount,2, '.', ','); ?></b></td>
                </tr>
                  <tr>
