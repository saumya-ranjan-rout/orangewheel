<button onclick="showAjaxModal('<?php echo site_url('modal/popup/add_income'); ?>');" 
    ...
    <tbody>
        <?php foreach ($income as $row) { ?>   
            <tr>
                ...
                <td>
                    <a onclick="showAjaxModal('<?php echo site_url('modal/popup/edit_income/'.$row['inc_id']);?>');" 
                        class="btn btn-info btn-sm">
                        <i class="fa fa-pencil"></i>&nbsp;Edit
                    </a>
                    <a onclick="confirm_modal('<?php echo site_url('admin/income/delete/'.$row['inc_id']); ?>')"
