...
<div class="panel panel-primary" data-collapsed="0">
    ...
    <div class="panel-body">
        ...
        <form role="form" class="form-horizontal form-groups" action="<?php echo site_url('admin/patient_item_issue/create'); ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="row" align="right" style="margin-top: 10px;">
                <label for="field-ta" class="col-sm-8 control-label"><?php echo get_phrase('received_amount'); ?></label>
            ...
            <div class="row" align="right" style="margin-top: 10px;">
                <label for="field-ta" class="col-sm-8 control-label"><?php echo get_phrase('due_amount'); ?></label>
            ...
            <div class="row" align="right" style="margin-top: 10px;">
                <label for="field-1" class="col-sm-8 control-label"><?php echo get_phrase('dispatched_through'); ?></label>
                <div class="col-sm-2">
            ...
            <div class="row" align="right" style="margin-top: 10px;">
                <label for="field-ta" class="col-sm-8 control-label"><?php echo get_phrase('delivery_note'); ?></label>
                <div class="col-sm-4">
...
<script type="text/javascript">
    ...
    if (tax_percentage === 'Nil' || tax_percentage === '') {
        ...
        var tax = basic_price * parseFloat(tax_percentage) / 100;
    }
    
    var total_price = basic_price + tax;
    
        
        $('#basic_price_' + append_id).attr('value', basic_price);
        $('#tax_' + append_id).attr('value', tax);
        $('#total_price_' + append_id).attr('value', total_price);
    ...
    function calculate_due_amount() {
        ...
        $('#due_amount').val(grand_total - received_amount);
