<div class="row">
    <div class="col-md-12">
<?php echo form_open(site_url('admin/bank_details/do_update'), array(
        ...
        <div class="panel panel-primary" >
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input type="text" class="form-control" name="bank_name"
                               value="<?php echo $this->db->get_where('bank_details', array('type' => 'bank_name'))->row()->description; ?>" required>
                    </div>
                </div>

                <div class="form-group">
                    <label  class="col-sm-3 control-label"><?php echo get_phrase('ac_name'); ?></label>
                    <div class="col-sm-5">
                        <input type="text" class="form-control" name="ac_name"
                               value="<?php echo $this->db->get_where('bank_details', array('type' => 'ac_name'))->row()->description; ?>" required>
                    </div>
                </div>

                <div class="form-group">
                    <label  class="col-sm-3 control-label"><?php echo get_phrase('ac_no'); ?></label>
                    <div class="col-sm-5">
                        <input type="text" class="form-control" name="ac_no"
                               value="<?php echo $this->db->get_where('bank_details', array('type' => 'ac_no'))->row()->description; ?>" required>
                    </div>
                </div>
                ...
                <!-- <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <textarea type="text" class="form-control" name="address"
                               > <?php echo $this->db->get_where('settings', array('type' => 'address'))->row()->description; ?></textarea>
                    </div>
                </div> -->
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input type="text" class="form-control" name="branch"
                               value="<?php echo $this->db->get_where('bank_details', array('type' => 'branch'))->row()->description; ?>">
                    </div>
                </div>
               ...
               <!-- <div class="form-group">
                ...
                <div class="form-group">
                    <label  class="col-sm-3 control-label"><?php echo get_phrase('ifsc_code'); ?></label>
                    <div class="col-sm-5">
                        <input type="text" class="form-control" name="ifsc_code"
                               value="<?php echo $this->db->get_where('bank_details', array('type' => 'ifsc_code'))->row()->description; ?>" required>
                    </div>
                </div>

                <div class="form-group">
                    <label  class="col-sm-3 control-label"><?php echo get_phrase('pan_no'); ?></label>
                    <div class="col-sm-5">
                        <input type="text" class="form-control" name="pan_no"
                               value="<?php echo $this->db->get_where('bank_details', array('type' => 'pan_no'))->row()->description; ?>">
                    </div>
                </div>
                    ...
                    <div class="col-sm-5">
                        ...
                        <div class="fileinput fileinput-new" data-provides="fileinput">
                            <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;" data-trigger="fileinput">
                                <img src="<?php echo base_url();?>uploads/logo2.png">
                            </div>
