...
<table class="table table-bordered table-striped datatable" id="table-2">
    ...
    <tbody>
        ...
        foreach ($patient_issues as $row) { ?>
            <tr>
                ...
                <td>
                      <a href="<?php echo site_url('admin/main_edit_patient_item_issue/invoice_edit/' . $row['id']); ?>" class="btn btn-primary">
  <i class="fa fa-pencil"></i> </a>
                    <a onclick="showAjaxModal('<?php echo site_url('modal/popup/patient_item_issue_invoice/' . $row['id']); ?>');" class="btn btn-default btn-sm">
                     ...
                     <a href="<?php echo site_url('admin/delete_patient_item_issue/invoice/' . $row['id']); ?>" class="btn btn-danger">
