            ...
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-body">
                    ...
                    <form role="form" class="form-horizontal form-groups" action="<?php echo site_url('admin/item/update/' . $row['id']); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                        <label for="field-1" class="col-sm-3 control-label"><?php echo 'Demo'; ?></label>
                        <div class="col-sm-7">
                          
            <input type="checkbox"id="checkbox"class="checkbox" onchange="updateDemo()" <?php if ($row['demo'] == 1) echo 'checked'; ?>>
         <input type="hidden" class="demo" id="demo" name="demo" value="<?php echo $row['demo']; ?>"></td>
                        </div>
                    </div>
                    
                              <div class="form-group">
                        <label for="field-1" class="col-sm-3 control-label"><?php echo 'Hearing Accessories'; ?></label>
                        <div class="col-sm-7">
                          
            <input type="checkbox"id="hearingaccessories_checkbox"class="hearingaccessories_checkbox" onchange="updateHearingaccessories()" <?php if ($row['hearing_accessories'] == 1) echo 'checked'; ?>>
         <input type="hidden" class="hearing_accessories" id="hearing_accessories" name="hearing_accessories" value="<?php echo $row['hearing_accessories']; ?>"></td>
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="field-1" class="col-sm-3 control-label"><?php echo 'Hearing Aid'; ?></label>
                        <div class="col-sm-7">
                          
            <input type="checkbox"id="hearingaid_checkbox"class="hearingaid_checkbox" onchange="updateHearingaid()" <?php if ($row['hearing_aid'] == 1) echo 'checked'; ?>>
         <input type="hidden" class="hearing_aid" id="hearing_aid" name="hearing_aid" value="<?php echo $row['hearing_aid']; ?>"></td>
                        </div>
                    </div>
...
// alert(i);
 ...
 var hiddenField = document.getElementById('demo');
...
function updateHearingaccessories() {

// alert(i);
 // Get the checkbox and hidden field elements
 var checkbox = document.getElementById('hearingaccessories_checkbox');
 var hiddenField = document.getElementById('hearing_accessories');
...
function updateHearingaid() {

// alert(i);
 // Get the checkbox and hidden field elements
 var checkbox = document.getElementById('hearingaid_checkbox');
 var hiddenField = document.getElementById('hearing_aid');
