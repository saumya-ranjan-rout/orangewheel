...
$conditions = array(
     'patient_id' => $param2,
     'date' => date('Y-m-d', strtotime($param3))
);
...
.watermark {
    ...
    <div id="invoice_print">
        ...
        <table width="100%" border="0">
        <tr>
                <td colspan="14"align="center"><h3 style="font-family:	Lucida Console;font-weight:bold;">Diagnosis</h3></td>
...
?>
                       ...
                       <td align="left"><?php echo $diagnosis_info['diagnosis_name']; ?></td>
                         <td align="center"><?php echo $row2->quantity; ?></td>
                          <td align="center"><?php echo $row2->diagnosis_price; ?></td>
                           <!-- <td class="text-center"><?php echo $row2->discount_type; ?></td> -->
        ...
        <table width="100%" border="0">
            <tr>
                <td align="right" width="90%"><h4><?php echo get_phrase('grand_total'); ?> :</h4></td>
                <td align="right"><h4>₹ <?php echo $row['sum_total_price']; ?> </h4></td>
            </tr>
        </table>
