        ...
        <?php foreach ($diagnosis_report_info as $row) { ?>   
            <tr>
                ...
                <td>
                    ...
                    <a onclick="confirm_modal('<?php echo site_url('admin/diagnosis_report/delete/'.$row['diagnosis_report_id']); ?>')"
    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-body">
                ...
                <form role="form" class="form-horizontal form-groups" action="<?php echo site_url('admin/diagnosis_report/create'); ?>" 
