...
<table class="table table-bordered table-striped datatable" id="table-2">
    ...
    <tbody>
        ...
        $patient_issues = $this->db->where(array('issue_type'=> $list, 'demo' => 1))->get('patient_item_issue')->result_array();
        foreach ($patient_issues as $row) { ?>
            <tr>
                            ...
                            foreach ($models as $row2) { ?>
                                <tr>
                                    <td style="text-align: center;">
                                        <?php
                                        $model_info = $this->db->get_where('demoitem', array('id' => $row2->model_id))->row();
                ...
                <td>
                      <a href="<?php echo site_url('admin/main_edit_patient_item_issue_trial/invoice_edit/' . $row['id']); ?>" class="btn btn-primary">
