        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-body">
                    ...
                    <form role="form" class="form-horizontal form-groups" action="<?php echo site_url('admin/bed_allotment/discharge/'.$row['bed_allotment_id']); ?>" 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <select name="bed_id" class="form-control select2" readonly>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <select name="patient_id" class="form-control select2" readonly>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input type="text" name="allotment_timestamp" class="form-control datepicker" id="field-1" value="<?php echo date("m/d/Y", $row['allotment_timestamp']); ?>" readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input type="text" name="discharge_timestamp" class="form-control datepicker" id="field-1" value="" required>
                            </div>
                        </div>
