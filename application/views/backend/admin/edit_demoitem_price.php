<?php
$single_item_info = $this->db->get_where('demoitem_price_details', array('id' => $param2))->result_array();
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-body">
                    ...
                    <form role="form" enctype="multipart/form-data" class="form-horizontal form-groups" action="<?php echo site_url('admin/change_demoitem_price/update/' . $row['id']); ?>" method="post">
