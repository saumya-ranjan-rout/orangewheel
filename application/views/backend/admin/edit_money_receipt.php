...
foreach($models as $model) { ?>
                ...
                <div class="row" style="margin-top: 10px;">
                    <div class="col-sm-2">
                        ...
                        <select name="model_id[]" class="form-control select2 srr" onchange="get_model_available_quantity(this.value, <?php echo $i; ?>)" required id="model_id_<?php echo $i; ?>" style="color: #999; background-color: #868686; pointer-events: none;">
                    ...
                    <div class="col-sm-2">
                        ...
                        <input type="text" class="form-control" id="discount_<?php echo $i; ?>" name="discount[]" value="<?php echo $model['discount']; ?>" readonly />
         <span id="after_discount_<?php echo $i; ?>"> <?php $after_amount =$result['unit_price']-$model['discount']; echo "<b>(".$result['unit_price'] . "-" . $model['discount'] . "=" .$after_amount.")</b>"; ?></span>
                    </div>
...
//alert(total_available_quantity);
