...
?>
    ...
    <div id="invoice_print">
        ...
        <table width="100%" border="0">
            ...
            <tr>
                <td colspan="14"align="center"><h3 style="font-family:	Lucida Console;font-weight:bold;">Sales Return Invoice</h3></td>
        ...
        <table  class="table table-bordered" width="100%" border="1" style="border-collapse:collapse;">
            <tbody>
                <tr>
                    <td colspan="4"width='25%'>challan No./invoice no.<br><b><?php echo $row['bill_no']; ?></b></td>
                    <td colspan="4"width='20%'>Date<br><b><?php echo date("d-m-Y", strtotime($row['invoice_date'])); ?></b></td>
                    <td colspan="4"width='20%'>Mode of Payment<br><b><?php echo $row['payment_mode']; ?></b></td>
                    <td colspan="5"width='20%'>Dispathed Through<br><b><?php echo $row['dispatched_through']; ?></b></td>
                    <td colspan="5"width='15%'>Return Date<br><b><?php echo $row['sales_return_date']; ?></b></td>
                </tr>
                <tr>
        ...
        <!-- min-height: 370px;max-height: 370px;overflow: auto; -->
            <thead>
                <tr>
                    <th class="text-center" style="overflow: hidden; width: 4%;">SN.</th>
                    ...
                    <th class="text-center" style="overflow: hidden; width: 8%;">HSN Code</th>
                    <th class="text-center" style=" overflow: hidden; width: 5%;" >Qty</th>
                    <th class="text-center" style="overflow: hidden; width: 5%;">Unit</th>
                    <th class="text-center" style="overflow: hidden; width: 12%;">Price</th>
                    <!--<th class="text-center" style="overflow: hidden; width: 5%;">Disc<br>(%)</th>-->
                    <th class="text-center" style="overflow: hidden; width: 17%;">Discount(Disc%)</th>
                    <th class="text-center" style="overflow: hidden; width: 5%;">Tax<br>(%)</th>
                    <th class="text-center" style="overflow: hidden; width: 8%;">Tax<br>Amount</th>
                    <th colspan="2" class="text-center" style="overflow: hidden; width: 13%;">Total Amount</th>
                </tr>
            </thead>
            <tbody>
                ...
                <div id="invoice_entry" >
                    ...
                    ?>
                        ...
                        <tr >
                            ...
                            <td style="border-bottom: 0;border-top: 0;overflow: hidden; width:8%;"><?php echo $model_info['hsn_code']; ?></td>
                            <td style="border-bottom: 0;border-top: 0;overflow: hidden; width:5%;text-align: center;"><?php echo $row2->quantity; ?></td>
                            <td style="border-bottom: 0;border-top: 0;overflow: hidden; width:5%;text-align: center;"><?php if($model_info['unit_name'] == "Piece"){ echo "Pcs"; }else{ echo $model_info['unit_name'];} ?></td>
                            <td style="border-bottom: 0;border-top: 0;overflow: hidden; width:12%;text-align: center;"><?php echo number_format($row2->price, 2, '.', ','); ?></td>
                            <!--<td style="border-bottom: 0;border-top: 0;overflow: hidden; width:5%;text-align: center;"><?php if ($row2->discount_percentage > 0) echo $row2->discount_percentage . "%"; ?></td>-->
                            <td style="border-bottom: 0;border-top: 0;overflow: hidden; width:17%;text-align: center;"><?php echo number_format($row2->discount, 2, '.', ','); ?><?php if ($row2->discount_percentage > 0) echo "(".$row2->discount_percentage . "%)"; ?></td>
                            <td style="border-bottom: 0;border-top: 0;overflow: hidden; width:5%;text-align: center;"><?php if ($row2->tax_percentage > 0) echo $row2->tax_percentage . "%"; ?></td>
                            <td style="border-bottom: 0;border-top: 0;overflow: hidden; width:8%;text-align: center;"><?php  echo  number_format($row2->tax, 2, '.', ','); ?></td>
                            <td colspan="2" style="border-bottom: 0;border-top: 0;overflow: hidden; width:13%;text-align: center;"><?php echo number_format($row2->total_price, 2, '.', ','); ?></td>
                        </tr>
     ...
     if ($row2->tax_percentage > 0) {
        ...
        if (in_array($tax_percentage, $tax_row)) {
            ...
            $tax_row_value[] = $row2->tax; // Initialize the count to 1
                ...
                <tr>
                    <td align="right" colspan="11" width="87%"><b>Total</b></td>
                    <td align="right" colspan="2" width="13%"><b>  <?php echo number_format($totalamount,2, '.', ','); ?></b></td>
                </tr>
                <tr>
            
            <td align="right" colspan="11" width="87%"><b>Advance Received</b></td>
            <td align="right" colspan="2" width="13%"><b><?php echo number_format($row["received_amount"],2, '.', ',');  ?></b></td>
        </tr>
        <tr>
   
            <td align="right" colspan="11" width="87%"><b>Final Amount Paid</b></td>
            <td align="right" colspan="2" width="13%"><b><?php echo number_format($row["due_amount"],2, '.', ',');  ?></b></td>
        </tr>
        <tr>
   
   <td align="right" colspan="11" width="87%"><b>Sales Returned Amount </b></td>
   <td align="right" colspan="2" width="13%"><b><?php echo number_format($row["sales_return_amount"],2, '.', ',');  ?></b></td>
</tr>
<tr>
   
   <td align="right" colspan="11" width="87%"><b>Sales Return Received</b></td>
   <td align="right" colspan="2" width="13%"><b><?php echo $total_return_amount = number_format($row["sales_return_due"],2, '.', ',');  ?></b></td>
</tr>
        ...
        <table table class="table table-bordered" width="100%" border="1" style="border-collapse:collapse;">
            <tr>
                <td style="font-size: 14px;">Amount Due (in words)<br><b><?php echo convertAmountToWords($total_return_amount); ?> Only</b></td>
            </tr>
        </table>
        ...
        <!-- <table table class="table table-bordered" width="100%" border="1" style="border-collapse:collapse;">
                ...
                if (max($tax_row_value) > 0) {
                   ...
                   ?>
                        ...
                        ?>    </td>
                                <td width='25%'><?php echo $taxrowtime."(".$taxrowvaluehalf.")";?></td>
                                <td width='25%'><?php echo $taxrowtime."(".$taxrowvaluehalf.")";?></td>
