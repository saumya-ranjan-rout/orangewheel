...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="panel panel-primary" data-collapsed="0">
                        ...
                        <div class="col-sm-7">
                            <select name="lr" id="lr" class="form-control">
                                ...
                                <!--  <option value="both"><?php echo get_phrase('both'); ?></option>-->
                                  <option value="KIT"><?php echo get_phrase('KIT'); ?></option>
            ...
            <input type="checkbox"id="checkbox"class="checkbox" onchange="updateDemo()">
         <input type="hidden" class="demo" id="demo" name="demo" value="0">
                        </div>
                    </div>
            ...
            <input type="checkbox" id="hearingaccessories_checkbox"class="hearingaccessories_checkbox" onchange="updateHearingaccessories()">
         <input type="hidden" class="hearing_accessories" id="hearing_accessories" name="hearing_accessories" value="0">
                        </div>
                    </div>
            ...
            <input type="checkbox" id="hearingaid_checkbox"class="hearingaid_checkbox" onchange="updateHearingaid()">
         <input type="hidden" class="hearing_aid" id="hearing_aid" name="hearing_aid" value="0">
                        </div>
                    </div>
