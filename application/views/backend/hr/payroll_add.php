    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="form-group">
                <label class="control-label" style="margin-bottom: 11px;"><?php echo get_phrase('employee'); ?> <small style="color:red;">*</small></label>
        ...
        <div class="col-md-3">
            <div class="form-group">
                <label class="control-label" style="margin-bottom: 11px;"><?php echo get_phrase('month'); ?> <small style="color:red;">*</small></label>
        ...
        <div class="col-md-3">
            <div class="form-group">
                <label class="control-label" style="margin-bottom: 11px;"><?php echo get_phrase('year'); ?> <small style="color:red;">*</small></label>
