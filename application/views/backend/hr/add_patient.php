...
<form role="form" class="form-horizontal form-groups" action="<?php echo site_url('hr/patient/create'); ?>" 
...
<div class="form-group">
<label for="field-ta" class="col-sm-3 control-label"><?php echo get_phrase('blood_group'); ?>  <small style="color:red;">*</small></label>
...
<?php foreach ($bloodgroup_info as $row) { ?>
    ...
    <div class="col-sm-7">
    <input type="number" name="guardian_no" class="form-control" id="guardian_no" required>
    </div>
    </div>
    <!-- <div class="form-group">
    ...
    <div class="col-sm-7">
    <input type="text" name="referred_by" class="form-control" id="referred_by" >
    </div>
    </div> -->
    <div class="form-group">
    <label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('Referred By'); ?></label>
    ...
    <div class="col-sm-7">
    <select name="referred_by" class="form-control" id="referred_by" required>
    ...
    <div class="col-sm-9">
    <input type="text" id="current_state" class="form-control" name="current_state">
    </div>
    </div>
    <div class="col-sm-12">
