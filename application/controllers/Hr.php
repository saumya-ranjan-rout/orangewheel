...
class Hr extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['page_title'] = get_phrase('hr_dashboard');
    ...
    function dashboard()
    {
        ...
        $page_data['page_title'] = get_phrase('hr_dashboard');
    ...
    function manage_language($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        //         ));
        //     }
        //     redirect(site_url('hr/manage_language/edit_phrase/' . $language), 'refresh');
        // }
        if ($param1 == 'do_update') {
            ...
            redirect(site_url('hr/manage_language'), 'refresh');
        }
    ...
    function system_settings($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'do_update') {
            ...
            $this->session->set_flashdata('message', get_phrase('settings_updated'));
            redirect(site_url('hr/system_settings'), 'refresh');
        }
    ...
    function sms_settings($param1 = '')
    {
        ...
        if ($param1 == 'do_update') {
            ...
            $this->session->set_flashdata('message', get_phrase('settings_updated'));
            redirect(site_url('hr/sms_settings'), 'refresh');
        }
    ...
    function department($task = "", $department_id = "")
    {
       if ($this->session->userdata('hr_login') != 1) {
        ...
        if ($task == "create") {
            ...
            redirect(site_url('hr/department'), 'refresh');
        }
    ...
    function department_facilities($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'add') {
            ...
            redirect(site_url('hr/department_facilities/' . $param2), 'refresh');
        }
        ...
        if ($param1 == 'edit') {
            ...
            redirect(site_url('hr/department_facilities/' . $param3), 'refresh');
        }
    ...
    function doctor($task = "", $doctor_id = "")
    {
        ...
        if ($task == "create") {
            ...
            redirect(site_url('hr/doctor'), 'refresh');
        }
        if ($task == "update") {
    ...
    function nurse($task = "", $nurse_id = "")
    {
        ...
        if ($task == "create") {
            ...
            redirect(site_url('hr/nurse'), 'refresh');
        }
    ...
    function pharmacist($task = "", $pharmacist_id = "")
    {
        ...
        if ($task == "create") {
            ...
            redirect(site_url('hr/pharmacist'), 'refresh');
        }
    ...
    function laboratorist($task = "", $laboratorist_id = "")
    {
       if ($this->session->userdata('hr_login') != 1) {
        ...
        if ($task == "create") {
            ...
            redirect(site_url('hr/laboratorist'), 'refresh');
        }
    ...
    function accountant($task = "", $accountant_id = "")
    {
        ...
        if ($task == "create") {
            ...
            redirect(site_url('hr/accountant'), 'refresh');
        }
    ...
    function receptionist($task = "", $receptionist_id = "")
    {
        ...
        if ($task == "create") {
            ...
            redirect(site_url('hr/receptionist'), 'refresh');
        }
...
/***************** Tarini 16-06-2023****************************/
    function hr($task = "", $hr_id = "")
    {
        ...
        if ($task == "create") {
            ...
            redirect(site_url('hr/hr'), 'refresh');
        }
        if ($task == "update") {
...
if ($duplicate_check) {
    ...
    redirect(site_url('hr/payroll'), 'refresh');
}
        else{
        ...
        redirect(site_url('hr/payroll_view/' . $user_type . '/' . $employee_id . '/' . $month . '/' . $year), 'refresh');
    }
    }
    ...
    function create_payroll()
    {
        ...
        redirect(site_url('hr/payroll_list'), 'refresh');
    }
