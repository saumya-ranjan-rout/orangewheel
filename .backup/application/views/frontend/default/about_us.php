            ...
            <div class="col-md-12">
                <div class="section-title section-title--style-1 text-center mb-4">
                    <h3 class="section-title-inner text-uppercase">
                        <?php echo get_phrase('about').' <b>'.$hospital_name.'</b>';?>
                    </h3>
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="home-widget widget-1">
                    ...
                    <h4><?php echo get_phrase('mission');?></h4>
                    <p>"To enhance lives through comprehensive audiological care, empowering individuals to experience the world of sound with confidence and clarity. We are dedicated to delivering personalized solutions, advanced technology, and compassionate support to improve the quality of life for our patients."</p>
                </div>
            </div>
            ...
            <div class="col-lg-6">
                ...
                <!-- <i class="fa fa-handshake-o"></i> -->
                    <h4><?php echo get_phrase('vision');?></h4>
                    <p>
                        "To be the leading audiology clinic recognized for excellence in hearing healthcare. We strive to create a harmonious world of communication, where every individual enjoys the beauty of sound, fostering connections, and enriching experiences. Through innovation and unwavering commitment, we aim to set new standards in hearing healthcare and make a lasting impact on the lives of those we serve."
                </p>
                </div>
            </div>
        </div>
