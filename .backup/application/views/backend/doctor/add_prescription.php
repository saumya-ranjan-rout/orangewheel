                        ...
                        <div class="col-sm-7">
                            <div class="date-and-time">
                                <input type="text" name="fdate_timestamp" class="form-control datepicker"
                                       data-format="D, dd MM yyyy"
                                        placeholder="<?php echo get_phrase('date');?>" required>
                                <input type="text" name="ftime_timestamp" class="form-control timepicker" data-template="dropdown" data-show-seconds="false" data-default-time="00:05 AM" data-show-meridian="false" data-minute-step="5"  placeholder="time here" required>
                            </div>
                        </div>
                    </div>
