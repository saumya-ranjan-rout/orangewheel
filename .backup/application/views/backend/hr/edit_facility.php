        ...
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-body">
                ...
                <form role="form" class="form-horizontal form-groups"
                      action="<?php echo site_url('hr/department_facilities/edit/'.$row['facility_id'].'/'.$row['department_id']); ?>"
                      method="post" enctype="multipart/form-data">

                    <div class="form-group">
                        <label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('title'); ?> <small style="color:red;">*</small></label>
