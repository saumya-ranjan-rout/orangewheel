    ...
    <ul id="main-menu" class="">
        ...
        <li class="<?php if ($page_name == 'dashboard') echo 'active'; ?> ">
            ...
            <li class="<?php if ($page_name == 'manage_department' || $page_name == 'department_facilities' || $page_name == 'manage_doctor' || 
                $page_name == 'manage_patient' || $page_name == 'manage_nurse' ||
                 $page_name == 'manage_pharmacist' || $page_name == 'manage_laboratorist' ||
            ...
            <a href="<?php echo site_url('hr/doctor');?>">
        ...
        <li class="<?php if ($page_name == 'manage_nurse') echo 'active'; ?> ">
            <a href="<?php echo site_url('hr/nurse');?>">
        ...
        <li class="<?php if ($page_name == 'manage_pharmacist') echo 'active'; ?> ">
            <a href="<?php echo site_url('hr/pharmacist');?>">
        ...
        <li class="<?php if ($page_name == 'manage_laboratorist') echo 'active'; ?> ">
            <a href="<?php echo site_url('hr/laboratorist');?>">
                <i class="fa fa-user"></i>
        ...
        <li class="<?php if ($page_name == 'manage_accountant') echo 'active'; ?> ">
            <a href="<?php echo site_url('hr/accountant');?>">
        ...
        <li class="<?php if ($page_name == 'manage_receptionist') echo 'active'; ?> ">
            <a href="<?php echo site_url('hr/receptionist');?>">
                <i class="fa fa-plus-square"></i>
        ...
        <li class="<?php if ($page_name == 'manage_hr') echo 'active'; ?> ">
            <a href="<?php echo site_url('hr/hr');?>">
                <i class="fa fa-user"></i>
