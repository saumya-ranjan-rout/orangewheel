...
<body>
    ...
    <div class="wrapper">
        ...
        <section class="gray-bg height-100vh d-flex align-items-center page-section-ptb " style="background-image: url('<?php echo base_url('assets/login_page/img/login_banner.jpg'); ?>'); background-size: cover; background-position: center;">
            <div class="container">
                <div class="row no-gutters justify-content-center">
                    <div class="col-lg-4 col-md-6 login-fancy-bg bg-overlay-black-0" style="background: url('<?php echo base_url('assets/login_page/img/bg11.jpg'); ?>');">
                        <div class="login-fancy pos-r d-flex">
                            <div class="text-center w-100 align-self-center">
                                <img src="<?php echo base_url('assets/login_page/img/logo3.jpg');?>" height="80" />
                                ...
                                <div class="remember-checkbox mb-30">
                                    <a href="#" class="float-right" id = "forgot_password_button" onclick="toggleView(this)" style="color: black;"><?php echo get_phrase('forgot_password'); ?>?</a>
                                     ...
                                     <!--<a href="<?php echo base_url();?>" class="float-left" style="color: black;">
                                       ...
                                       <img src="<?php echo base_url('assets/login_page/img/doctor-smart-logo.png');?>" class="float-left" height="40" /> 
                                </div>
                            </div>
                        </div>
