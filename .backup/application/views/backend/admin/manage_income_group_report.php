...
<div class="row">
    <form action="<?php echo site_url('admin/income_group_report'); ?>" method="post" enctype="multipart/form-data">
...
<table class="table table-bordered table-striped datatable" id="table-2">
    ...
    <tbody>
        ...
        $filteredIncome = array_filter($income, function($row) use ($dateFrom, $dateTo) {
