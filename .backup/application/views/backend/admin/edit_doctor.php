...
?>
            ...
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-heading">
                    <div class="panel-title">
                        <h3><?php echo get_phrase('edit_audiologists'); ?></h3>
                    </div>
                </div>

                <div class="panel-body">

                    <form role="form" class="form-horizontal form-groups " action="<?php echo site_url('admin/doctor/update/'.$row['doctor_id']); ?>" 
  ...
  <option value="other" <?php if($row['gender']=="other"){ echo"selected"; } ?>>Other</option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="field-ta" class="col-sm-3 control-label"><?php echo get_phrase('department'); ?>  <small style="color:red;">*</small></label>
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <input type="file" name="aadhar_card_file" class="form-control " id="field-1" >
                        </div>
                    </div>
                       <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <input type="file" name="pan_card_file" class="form-control " id="field-1">
                        </div>
                    </div>
                       <div class="form-group">
