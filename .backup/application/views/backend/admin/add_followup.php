...
<div class="form-group answer" >
 ...
 <div class="form-group">
                         ...
                         <div class="form-group">
                            <label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('call_duration'); ?> <small style="color:red;">*</small></label>

                            <div class="col-sm-5">
                                <input type="text" name="call_duration" class="form-control" placeholder="call duration" required>
                            </div>
                        </div>
