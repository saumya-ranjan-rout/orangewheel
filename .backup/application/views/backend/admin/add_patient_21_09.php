...
<?php foreach ($bloodgroup_info as $row) { ?>
    ...
    <div class="col-sm-7">
    <input type="text" name="guardian_no" pattern="[0-9]{10}" class="form-control" id="guardian_no" required>
    </div>
    </div>
    <div class="form-group">
   ...
   <div class="form-group">
      <label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('ID Card'); ?> <small style="color:red;">*</small></label>

      <div class="col-sm-4">
        <input type="text" name="id_card" class="form-control" id="field-1" required>
      </div>
<div class="col-sm-3">
        <input type="file" name="id_card_file" class="form-control " id="field-1" accept=".jpg, .jpeg, .png" required>
      </div>
    </div>
    <div class="form-group">
