        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-body">
                    ...
                    <form role="form" class="form-horizontal form-groups" action="<?php echo site_url('admin/blood_donor/update/'.$row['blood_donor_id']); ?>" 
                        ...
                        <div class="form-group">
                            <label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('last_donation_date'); ?> <small style="color:red;">*</small></label>
