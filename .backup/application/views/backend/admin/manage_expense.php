<button onclick="showAjaxModal('<?php echo site_url('modal/popup/add_expense'); ?>');" 
    ...
    <tbody>
        <?php foreach ($expense as $row) { ?>   
            <tr>
                ...
                <td>
                    <a onclick="showAjaxModal('<?php echo site_url('modal/popup/edit_expense/'.$row['exp_id']);?>');" 
                        class="btn btn-info btn-sm">
                        <i class="fa fa-pencil"></i>&nbsp;Edit
                    </a>
                    <a onclick="confirm_modal('<?php echo site_url('admin/expense/delete/'.$row['exp_id']); ?>')"
