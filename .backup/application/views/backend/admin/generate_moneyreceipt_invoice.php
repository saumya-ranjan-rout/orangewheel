...
<ol class="breadcrumb bc-3" style="margin-bottom: 0px;">
    ...
    <li><?php echo get_phrase('generate_money_receipt_invoice') ?></li>
</ol>
<br>
...
<div class="panel panel-primary" data-collapsed="0">
    ...
    <div class="panel-heading">
        <div class="panel-title">
            <h3><?php echo get_phrase('generate_money_receipt_invoice'); ?></h3>
        </div>
    </div>

    <div class="panel-body">

        <form role="form" class="form-horizontal form-groups" action="<?php echo site_url('admin/patient_item_issue/update'); ?>" method="post" enctype="multipart/form-data">
            <div class="row">
                <div class="col-sm-3">
                ...
                <div class="col-sm-3">
                    ...
                    <input type="text" name="date" class="form-control datepicker" value="<?php echo date('m/d/Y', strtotime($patient_item_issue_info["money_receipt_date"])); ?>" id="date" required>
                </div>
                <div class="col-sm-3">
                    <label><?php echo get_phrase('patient'); ?> <small style="color:red;">*</small></label>
                    <select name="patient_id" class="form-control select2" required disabled>
...
foreach($models as $model) { ?>
                ...
                <div class="row" style="margin-top: 10px;">
                    <div class="col-sm-2">
                        ...
                        <select name="model_id[]" class="form-control select2" onchange="get_model_available_quantity(this.value, 1)" required disabled>
                    ...
                    <div class="col-sm-2">
                        ...
                        <input type="text" class="form-control" id="discount_percentage_1" name="discount_percentage[]" onkeyup="calculate_total_price_by_discount(1)" value="<?php echo $model['discount_percentage']; ?>" readonly />
                    </div>
                    <div class="col-sm-2">
...
<?php  }  ?>
            ...
            <div class="row" align="right" style="margin-top: 10px;">
                ...
                <div class="col-sm-2">
                    <input type="number" name="due_amount" class="form-control" id="due_amount" value="<?php echo $patient_item_issue_info['due_amount']; ?>"  onkeyup="change_submitbutton_attribute(<?php echo $patient_item_issue_info['due_amount']; ?>)"/>
                </div>
            </div>
