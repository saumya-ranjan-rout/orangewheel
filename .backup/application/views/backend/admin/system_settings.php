<button class="btn btn-primary pull-right" id="addUnitBtn">
...
<script>
    $(document).ready(function () {
        $('#addUnitBtn').click(function () {
            $('#mesg').removeClass($('#mesg').attr('class')).addClass('btn btn-primary');
            $('#mesg').text("Please Wait.Mail Sending....");
            $.ajax({
                type: 'POST',
                ...
                success: function (response) {
                   ...
                   $('#mesg').removeClass($('#mesg').attr('class')).addClass('btn btn-success');
                   $('#mesg').text("Mail Sent Successfully");
                   setTimeout(function() {
            location.reload();
        }, 5000); 
                },
                error: function () {
                   ...
                   $('#mesg').removeClass($('#mesg').attr('class')).addClass('btn btn-danger');
                   $('#mesg').text("Error Sending Mail");
                   setTimeout(function() {
            location.reload();
        }, 5000); 
                }
