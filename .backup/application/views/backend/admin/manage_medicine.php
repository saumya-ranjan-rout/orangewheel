...
<table class="table table-bordered table-striped datatable" id="table-2">
    <thead>
        <tr>
            ...
            <th><?php echo get_phrase('alert_quantity'); ?></th>
    ...
    <tbody>
        <?php foreach ($medicine_info as $row) { ?>   
            <tr>
                <td>
                    <img src="<?php echo $this->crud_model->get_image_url('medicine' , $row['medicine_id']);?>" 
                ...
                <td>
                <?php $unit_name = $this->db->get_where('unit' , array('unit_id' => $row['unit_id'] ))->row()->unit_name;
                        echo $unit_name;?>
                </td>
                ...
                <td>
                    ...
                    <a onclick="confirm_modal('<?php echo site_url('admin/medicine/delete/' . $row['medicine_id']); ?>')"
