<button onclick="showAjaxModal('<?php echo site_url('modal/popup/add_item_category'); ?>');" class="btn btn-primary pull-right">
    <i class="fa fa-plus"></i>&nbsp;<?php echo get_phrase('add_item_category'); ?>
</button>
        ...
        <?php foreach ($item_category_info as $row) { ?>
            <tr>
               ...
               <!-- <td><?php echo $row['description'] ?></td>-->
                <td>
                    <a onclick="showAjaxModal('<?php echo site_url('modal/popup/edit_item_category/' . $row['id']); ?>');" class="btn btn-info btn-sm">
                        <i class="fa fa-pencil"></i>&nbsp;
                        <?php echo get_phrase('edit'); ?>
                    </a>
                    <a onclick="confirm_modal('<?php echo site_url('admin/item_category/delete/' . $row['id']); ?>')" class="btn btn-danger btn-sm">
