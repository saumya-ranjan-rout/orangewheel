...
<div class="col-sm-6">
               ...
               <form method="post" enctype="multipart/form-data" action="<?php echo site_url('admin/pres_upload/'.$row['patient_id']. '/' . $row['id']); ?>">
                ...
                <input type="file" name="prescription_document"accept="image/jpeg,image/jpg, image/png" required><button type="submit"  class="btn btn-primary btn-sm hidden-print">
