        ...
        <!-- min-height: 370px;max-height: 370px;overflow: auto; -->
            <thead>
                <tr>
                    ...
                    <th class="text-center" style="overflow: hidden; width: 10%;">Discount</th>
                ...
                <div id="invoice_entry" >
                    ...
                    ?>
                        ...
                        <tr >
                            ...
                            <td style="border-bottom: 0;border-top: 0;overflow: hidden; width:5%;"><?php if ($row2->discount_percentage > 0) echo $row2->discount_percentage . "%"; ?></td>
                            <td style="border-bottom: 0;border-top: 0;overflow: hidden; width:10%;"><?php echo $row2->discount; ?></td>
