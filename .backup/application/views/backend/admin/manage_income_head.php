<button onclick="showAjaxModal('<?php echo site_url('modal/popup/add_income_head'); ?>');" 
...
<table class="table table-bordered table-striped datatable" id="table-2">
    ...
    <tbody>
        <?php foreach ($income_head as $row) { ?>   
            <tr>
                <td><?php echo $row['income_head_name']?></td>                
                <td><?php echo $row['description']?></td>                      
                <td>
                    <a onclick="showAjaxModal('<?php echo site_url('modal/popup/edit_income_head/'.$row['income_id']);?>');" 
                        class="btn btn-info btn-sm">
                        <i class="fa fa-pencil"></i>&nbsp;Edit
                    </a>
                    <a onclick="confirm_modal('<?php echo site_url('admin/income_head/delete/'.$row['income_id']); ?>')"
