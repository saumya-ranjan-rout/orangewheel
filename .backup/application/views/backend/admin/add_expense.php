<?php $expense_head = $this->db->get('expense_head')->result_array(); ?>
<div class="row">
    <div class="col-md-12">
        ...
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-body">
                ...
                <form role="form" class="form-horizontal form-groups validate"
                    action="<?php echo site_url('admin/expense/create'); ?>" 
                        ...
                        <div class="col-sm-7">
                            <select name="expense_head_id" class="form-control">
                                ...
                                <?php foreach ($expense_head as $row) { ?>
                                    <option value="<?php echo $row['expense_id']; ?>"><?php echo $row['expense_head_name']; ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div> 
